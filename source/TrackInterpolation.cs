...
//{
//	public static Vector3 GetPositionFromKey(TrackPoint a, TrackPoint b, float t)
//	{
...
//	private static int TangentDirectionFactor(TrackPoint a, TrackPoint b)
//	{
//		Vector3 pA = a.LocalCoordinate;
//		Vector3 pB = b.LocalCoordinate;
...
//	public static Vector3 GetForwardVectorFromKey(TrackPoint a, TrackPoint b, float t)
//	{
//		float e = 0.01f;
//		if (t + e >= 1)
//		{
...
//	public static double GetLengthOfSegment(TrackPoint a, TrackPoint b)
//	{
//		double sum = 0;
//		float e = 0.05f;
...
//	public static float GetClosestKey(TrackPoint a, TrackPoint b, Vector3 position, float precision = 0.01f)
//	{
...
//	public static Vector3[] SampleEquidistantPoints(TrackPoint a, TrackPoint b, int numPoints)
//	{
...
//	public static float[] SampleEquidistantKeys(TrackPoint a, TrackPoint b, int numPoints)
//	{
//		if (numPoints < 2)
//		{
