    ...
    internal class ElectricityCollectorComponent : VehicleComponent
    {
        ...
        protected override void OnTick(double delta)
        {
            ...
            if (trackPointId != Vehicle.currentRoute.points[Vehicle.routePointIndex]) 
            {
                ...
                lineVoltage = double.Parse(WorldManager.track.points[trackPointId].linked_nodes[prevTrackPointId].tags["voltage"]);
                lineFrequency = double.Parse(WorldManager.track.points[trackPointId].linked_nodes[prevTrackPointId].tags["frequency"]);
