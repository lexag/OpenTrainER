...
//public class TrackPointOld : WorldObject
//{
//    Dictionary<TrackPoint, double> neighbourDistances = new Dictionary<TrackPoint, double>();
//    public Vector3 tangentVector;
//    public bool isInstanced = false;

//    public Dictionary<TrackPoint, double> NeighbourDistances { get { return neighbourDistances; } }

//    public TrackPointOld() : base() { }
//    public TrackPointOld(LatLon worldCoordinate) : base(worldCoordinate) { }


//    public void AddNeighbour(TrackPoint neighbour)
//    {
...
//        Tuple<TrackPoint, TrackPoint> recordHolder = null;
//        foreach (TrackPoint a in neighbourDistances.Keys)
//        {
//            foreach (TrackPoint b in neighbourDistances.Keys)
//            {
...
//                    recordHolder = new Tuple<TrackPoint, TrackPoint>(a, b);
//                }
//            }
//        }
